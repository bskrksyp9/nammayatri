...
INSERT INTO atlas_bpp_dashboard.access_matrix (id, role_id, api_entity, user_access_type, user_action_type)
    ...
    SELECT
        ...
        T1.api_entity,
        'USER_FULL_ACCESS',
        unnest (ARRAY ['MERCHANT_UPDATE','MERCHANT_COMMON_CONFIG_UPDATE','DRIVER_POOL_CONFIG_UPDATE','DRIVER_POOL_CONFIG_CREATE','DRIVER_INTELLIGENT_POOL_CONFIG_UPDATE','ONBOARDING_DOCUMENT_CONFIG_UPDATE','ONBOARDING_DOCUMENT_CONFIG_CREATE' ,'MAPS_SERVICE_CONFIG_UPDATE', 'MAPS_SERVICE_USAGE_CONFIG_UPDATE','SMS_SERVICE_CONFIG_UPDATE','SMS_SERVICE_USAGE_CONFIG_UPDATE', 'VERIFICATION_SERVICE_CONFIG_UPDATE'])
...
INSERT INTO atlas_bpp_dashboard.access_matrix (id, role_id, api_entity, user_access_type, user_action_type)
    ...
    SELECT
        ...
        T1.api_entity,
        'USER_FULL_ACCESS',
        unnest (ARRAY ['CUSTOMER_LIST','CUSTOMER_INFO'])
    FROM atlas_bpp_dashboard.access_matrix AS T1
...
INSERT INTO atlas_bpp_dashboard.access_matrix (id, role_id, api_entity, user_access_type, user_action_type)
    ...
    SELECT
        ...
        T1.api_entity,
        'USER_FULL_ACCESS',
        unnest (ARRAY ['ISSUE_LIST','ISSUE_CATEGORY_LIST','ISSUE_INFO','ISSUE_FETCH_MEDIA'])
    FROM atlas_bpp_dashboard.access_matrix AS T1
...
INSERT INTO atlas_bpp_dashboard.access_matrix (id, role_id, api_entity, user_access_type, user_action_type)
    ...
    SELECT
        ...
        T1.api_entity,
        'USER_FULL_ACCESS',
        unnest (ARRAY ['VOLUNTEER_BOOKING_INFO'])
    FROM atlas_bpp_dashboard.access_matrix AS T1
...
INSERT INTO atlas_bpp_dashboard.access_matrix (id, role_id, api_entity, user_access_type, user_action_type)
    ...
    SELECT
        ...
        T1.api_entity,
        'USER_FULL_ACCESS',
        unnest (ARRAY ['VOLUNTEER_ASSIGN_CREATE_AND_START_OTP_RIDE'])
    FROM atlas_bpp_dashboard.access_matrix AS T1
