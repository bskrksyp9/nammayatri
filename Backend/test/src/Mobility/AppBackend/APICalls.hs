...
appBookingCancellationReasonsList :: Id BRB.Booking -> Text -> ClientM SRC.CancellationReasonsRes
appBookingStatus :<|> appBookingCancellationReasonsList :<|> appBookingList = client (Proxy :: Proxy AppBooking.API)
