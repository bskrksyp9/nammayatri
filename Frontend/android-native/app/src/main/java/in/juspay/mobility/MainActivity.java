    ...
    public String getDeviceDetails()
    {
        ...
        try {
            ...
            if(bBrand == null || bBrand == "")
                bBrand="null";
            if(bVersion == null || bVersion == "")
                bVersion = "null";
            else
                bVersion = "Android v"+bVersion;

            deviceDetails+=bBrand+"/";
            deviceDetails+=bModel+"/";
            deviceDetails+=bVersion+"/";
            deviceDetails+=deviceRAM + "/";
            deviceDetails+=dim[1]+"/";
            deviceDetails+=dim[0];
