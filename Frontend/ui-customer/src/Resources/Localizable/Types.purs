...
type THE_DESTINATION_IS_TOO_CLOSE = String
...
type LIVE_STATS_DASHBOARD = String
type CHECK_OUT_LIVE_STATS = String
type EMERGENCY_CONTACS_ADDED_SUCCESSFULLY = String
type NO_CONTACTS_FOUND_ON_DEVICE_TO_ADD = String
