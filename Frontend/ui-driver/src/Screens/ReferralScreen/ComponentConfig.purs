...
genericHeaderConfig state = let
  ...
  genericHeaderConfig' = config
    ...
    , textConfig {
        text = if state.props.stage == ST.LeaderBoard then "Contest" else if state.props.stage == ST.ReferralFlow then (getString REFERRAL_ENROLMENT) else (getString REFERRALS)
